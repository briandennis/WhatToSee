...
var EmptyStar = React.createClass({
  ...
  render: function () {
    return React.createElement('i', { className: 'fa fa-star emptyStar' });
  }
});
...
var FilledStar = React.createClass({
  ...
  render: function () {
    return React.createElement('i', { className: 'fa fa-star filledStar' });
  }
});
...
var Movie = React.createClass({
  ...
  render: function () {
    ...
    var moviePoster = React.createElement(
      'div',
      { className: 'iconDiv' },
...
var PrimaryEntry = React.createClass({
  ...
  getMovie: function () {
    ...
    var getMovie = function (name) {
      ...
      //format URL
      var movieUrl = 'https://whattosee.herokuapp.com/api?movie=' + name;
    ...
    if (this.state.progression === -1) {
      components = React.createElement(
        ...
        React.createElement(
          ...
          ' will use an artificial neural network to predict which movie currently in theaters you would like most!'
        ),
        React.createElement(
          'div',
          { className: 'button' },
          React.createElement(
            'div',
            { className: 'resetWrapper', onClick: this.reset },
            React.createElement(
              'h3',
              null,
              'Start'
      ...
      var getBoxOffice = function (name) {
        ...
        //format URL
        var movieUrl = 'https://whattosee.herokuapp.com/api/out';
      ...
      components = React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'h2',
            null,
            'Okay, thanks for the info! You should go see...'
          )
        ),
        React.createElement(
          'div',
...
},{"react":158,"react-dom":28,"react-rating":29}],160:[function(require,module,exports){
